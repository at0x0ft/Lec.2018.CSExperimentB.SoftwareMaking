...
public class Round {
    ...
    private ArrayList<Player> _playerList;   // ゲーム参加者の順番リスト
    ...
    public Round(ArrayList<Player> playerList, ArrayList<Card> deck, boolean hasDuchess, boolean hasPrince, boolean hasKing) {
        // 初期化処理
    ...
    private void turn() {
        Player turnPlayer = this._playerList.pop();
    ...
    private void winJudge() {
        ...
        Player winPlayer = this._playerList[0];
